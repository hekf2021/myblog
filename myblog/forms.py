...
class RegForm(forms.Form):
    ...
    password = forms.CharField(label='密码',
                               max_length=8,
                               min_length=3,
                               widget=forms.PasswordInput(attrs={'class':'form-control','placeholder':'请输入3-8位的密码'}))
    password_again = forms.CharField(label='确认密码',
                               max_length=8,
                               min_length=3,
                               widget=forms.PasswordInput(attrs={'class':'form-control','placeholder':'请输入3-8位的确认密码'}))
